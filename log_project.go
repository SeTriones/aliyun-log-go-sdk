...
func (p *LogProject) ListLogStore() ([]string, error) {
	...
	r, buf, err := request(p, "GET", uri, h, nil)
	if err != nil {
...
func (p *LogProject) GetLogStore(name string) (*LogStore, error) {
	...
	r, buf, err := request(p, "GET", "/logstores/"+name, h, nil)
	if err != nil {
		return nil, NewClientError(err.Error())
	}
...
func (p *LogProject) CreateLogStore(name string, ttl, shardCnt int) error {
	...
	r, body, err := request(p, "POST", "/logstores", h, body)
	if err != nil {
		return NewClientError(err.Error())
	}
...
func (p *LogProject) DeleteLogStore(name string) (err error) {
	...
	r, body, err := request(p, "DELETE", "/logstores/"+name, h, nil)
	if err != nil {
		return NewClientError(err.Error())
	}
...
func (p *LogProject) UpdateLogStore(name string, ttl, shardCnt int) (err error) {
	...
	r, body, err := request(p, "PUT", "/logstores/"+name, h, body)
	if err != nil {
		return NewClientError(err.Error())
	}
...
func (p *LogProject) GetMachineGroup(name string) (m *MachineGroup, err error) {
	...
	resp, buf, err := request(p, "GET", "/machinegroups/"+name, h, nil)
	if err != nil {
		return nil, NewClientError(err.Error())
	}
...
func (p *LogProject) CreateMachineGroup(m *MachineGroup) error {
	...
	resp, body, err := request(p, "POST", "/machinegroups", h, body)
	if err != nil {
		return NewClientError(err.Error())
	}
...
func (p *LogProject) UpdateMachineGroup(m *MachineGroup) (err error) {
	...
	r, body, err := request(p, "PUT", "/machinegroups/"+m.Name, h, body)
	if err != nil {
		return NewClientError(err.Error())
	}
...
func (p *LogProject) DeleteMachineGroup(name string) (err error) {
	...
	r, body, err := request(p, "DELETE", "/machinegroups/"+name, h, nil)
	if err != nil {
		return NewClientError(err.Error())
	}
...
func (p *LogProject) GetConfig(name string) (c *LogConfig, err error) {
	...
	r, buf, err := request(p, "GET", "/configs/"+name, h, nil)
	if err != nil {
		return nil, NewClientError(err.Error())
	}
...
func (p *LogProject) UpdateConfig(c *LogConfig) (err error) {
	...
	r, body, err := request(p, "PUT", "/configs/"+c.Name, h, body)
	if err != nil {
		return NewClientError(err.Error())
	}
...
func (p *LogProject) CreateConfig(c *LogConfig) (err error) {
	...
	r, body, err := request(p, "POST", "/configs", h, body)
	if err != nil {
		return NewClientError(err.Error())
	}
...
func (p *LogProject) DeleteConfig(name string) (err error) {
	...
	r, body, err := request(p, "DELETE", "/configs/"+name, h, nil)
	if err != nil {
		return NewClientError(err.Error())
	}
...
func (p *LogProject) ApplyConfigToMachineGroup(confName, groupName string) (err error) {
	...
	r, buf, err := request(p, "PUT", uri, h, nil)
	if err != nil {
		return NewClientError(err.Error())
	}
...
func (p *LogProject) RemoveConfigFromMachineGroup(confName, groupName string) (err error) {
	...
	uri := fmt.Sprintf("/machinegroups/%v/configs/%v", groupName, confName)
	r, buf, err := request(p, "DELETE", uri, h, nil)
	if err != nil {
		return NewClientError(err.Error())
	}
